...
- **Payment Requests:** Review and approve/reject payment requests
...
- Check that your profile role is set to 'admin'
...
For any issues, check the browser console for error messages or contact technical support.
